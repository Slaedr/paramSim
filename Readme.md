...
## Postprocessing simulation outputs

The program `scripts/ex_datacombine_mpi.py` reads one or more ensemble directory trees (generated by eg. run_cluster.py), combines them in a batch-interleaved manner, and writes them into a HDF5 file with two arrays, 'mesh' and 'fields'.
