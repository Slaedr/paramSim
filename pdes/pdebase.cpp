                                                  ...
                                                  const SolverParams& solver_params)
{
    if(params.pde_solver == "poisson_cg") {
        return std::make_unique<pde::PoissonCG<dim>>(params.test_case, params.fe_degree,
                params.initial_resolution, params.refine_levels, params.output_path, solver_params);
        ...
        return std::make_unique<pde::ConvdiffHDG<dim>>(ccase, params.fe_degree,
                params.initial_resolution, params.refine_levels, params.is_adaptive,
                params.output_path, solver_params);
    } else if(params.pde_solver == "minimal_surface") {
        return std::make_unique<pde::MinimalSurface<dim>>(params.test_case, params.fe_degree,
                params.initial_resolution, params.refine_levels, params.is_adaptive,
                params.output_path, solver_params);
    } else {
