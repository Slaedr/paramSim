/* ---------------------------------------------------------------------
 * This file is adapted from the Deal.II library.
 *
 * The Deal.II library is Copyright (C) 2013 - 2023 by the deal.II authors
 *
                   ...
                   char *argv[])
{
    ...
    PDEParams pdeparams{
        common_params.solver_str,         common_params.fe_degree,
